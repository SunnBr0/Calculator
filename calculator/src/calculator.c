...
int main() {
	...
	char operation;
	char next;
	printf("вы хотите работать с векторами ");
	...
	printf("^ вы можете возвести в степень даже в отрицательную ( 2 ^ 3 ) , ( 5 ^ -2 )\n");
	printf("! вы можете найти факториал числа ( 5 ! )\n\n");
	do {
		printf("С чем будете работать с числами или векторами (0 - числа, 1-векторами)\n"); // выбор с чем работать с числами или с векторами
		scanf("%i",&vbor);
		if(vbor == 1){
